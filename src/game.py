...
# Load images level 2
background_image_2 = pygame.image.load("assets/background/background_2.png").convert()
background_image_2 = pygame.transform.scale(background_image_2, (SCREEN_WIDTH, SCREEN_HEIGHT))

ground_image_2 = pygame.image.load("assets/platforms/main-platform/ground_2.png").convert()
...
#settings screen
setting_bg = pygame.image.load("assets/background/volume_bg.png").convert_alpha()
...
tutorial_btn_forward_rect = sc_tutorial_btn_forward.get_rect(midbottom=(SCREEN_WIDTH - 50, SCREEN_HEIGHT // 2))
tutorial_btn_back_rect = sc_tutorial_btn_back.get_rect(midbottom=(50, SCREEN_HEIGHT // 2))

# Levels screen
levels_bg = pygame.image.load("assets/background/level_bg.png").convert_alpha()
levels_tekst = pygame.image.load("assets/tekst/Levels.png").convert_alpha()

level_1 = pygame.image.load("assets/buttons/level_1.png").convert_alpha()
level_1_rect = level_1.get_rect(midbottom = (280,280))

level_2 = pygame.image.load("assets/buttons/level_2.png").convert_alpha()
level_2_rect = level_2.get_rect(midbottom = (480,280))

level_3 = pygame.image.load("assets/buttons/level_3.png").convert_alpha()
level_3_rect = level_3.get_rect(midbottom = (680,280))

level_4 = pygame.image.load("assets/buttons/level_4.png").convert_alpha()
level_4_rect = level_4.get_rect(midbottom = (280,400))

level_5 = pygame.image.load("assets/buttons/level_5.png").convert_alpha()
level_5_rect = level_5.get_rect(midbottom = (480,400))

level_6 = pygame.image.load("assets/buttons/level_6.png").convert_alpha()
level_6_rect = level_6.get_rect(midbottom = (680,400))

exit_lvl_btn_rect = exit_btn.get_rect(midbottom = (790,160))

# Obstacles
spike_1 = pygame.image.load("assets/spikes/obstacle_1.png").convert_alpha()
...
# List of songs
songs = []
for file in os.listdir('assets/songs'):
    if file.endswith('.mp3'):
        songs.append(os.path.join('assets/songs', file))
...
# Count for music so it pauses in the loop
count = 0
...
while running:
    ...
    # Level 1
        ...
        if (keys[pygame.K_w] or keys[pygame.K_UP] or keys[pygame.K_SPACE]) and not is_jumping:
            ...
            pygame.mixer.Sound('sound_effects/jump.wav').play()
            pygame.mixer.Sound('sound_effects/jump.wav').set_volume(0.05)
            is_jumping = True
        ...
        if cube_y >= SCREEN_HEIGHT - ground_height - CUBE_SIZE:
            cube_y = SCREEN_HEIGHT - ground_height - CUBE_SIZE
            cube_y_velocity = 0
            pygame.mixer.Sound('sound_effects/slide.wav').play()
            pygame.mixer.Sound('sound_effects/slide.wav').set_volume(0.05)
            is_jumping = False
...
# Move obstacles with the ground
spike_1_rect.x -= cube_speed
if spike_1_rect.x < -spike_1.get_width():
    spike_1_rect.x = SCREEN_WIDTH
