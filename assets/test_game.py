...
block_1_rect = block_1.get_rect(midbottom=(700, 400))
...
def update_tutorial_screen():
    ...
    tutorial_images = [sc_tutorial1_btn, sc_tutorial2_btn, sc_tutorial3_btn, sc_tutorial4_btn, sc_tutorial5_btn,
                       sc_tutorial6_btn]
